...
#define ENCODER_INTERFACE_ABZ 4
#define ENCODER_INTERFACE_LINEAR_HALL 5
#define ENCODER_INTERFACE_ANALOG 6
#define ENCODER_INTERFACE_ABZ_SPI 7

/* 编码器类型 */
#define ENCODER_MT6701 (ENCODER_INTERFACE_SPI << 8 | 1)
#define ENCODER_MT6835_SPI_ABZ (ENCODER_INTERFACE_ABZ_SPI << 8 | 1)
#define ENCODER_UVW (ENCODER_INTERFACE_ABZ << 8 | 2)
#define ENCODER_ABZ (ENCODER_INTERFACE_ABZ << 8 | 3)
