...
#define BOARD_ECAT_SUPPORT_RUN_ERROR_LED (1) /* board not supports RUN/ERROR led */

#define BOARD_ECAT_LED_RUN_CTRL_INDEX 7
#define BOARD_ECAT_LED_ERROR_CTRL_INDEX 8
...
#define BOARD_ECAT_NMII_LINK0_CTRL_INDEX 5
#define BOARD_ECAT_NMII_LINK1_CTRL_INDEX 0
#define BOARD_ECAT_NMII_LINK2_CTRL_INDEX 1
...
#define BOARD_BUS_VOLIATE_ADC_CH 0
